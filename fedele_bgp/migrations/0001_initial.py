# Generated by Django 4.2.6 on 2024-05-20 16:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('description', models.CharField(blank=True, max_length=200)),
                ('export_policies', models.ManyToManyField(blank=True, related_name='group_export_policies', to='fedele_bgp.routingpolicy')),
                ('import_policies', models.ManyToManyField(blank=True, related_name='group_import_policies', to='fedele_bgp.routingpolicy')),
                ('tags', taggit.managers.TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('match_community', models.ManyToManyField(blank=True, related_name='+', to='fedele_bgp.community')),
                ('match_ip_address', models.ManyToManyField(blank=True, related_name='plrules', to='fedele_bgp.prefixlist')),
                ('match_ipv6_address', models.ManyToManyField(blank=True, related_name='plrules6', to='fedele_bgp.prefixlist')),
                ('routing_policy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rules', to='fedele_bgp.routingpolicy')),
                ('tags', taggit.managers.TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prefix_list', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prefrules', to='fedele_bgp.prefixlist')),
                ('tags', taggit.managers.TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('export_policies', models.ManyToManyField(blank=True, related_name='session_export_policies', to='fedele_bgp.routingpolicy')),
                ('import_policies', models.ManyToManyField(blank=True, related_name='session_import_policies', to='fedele_bgp.routingpolicy')),
                ...
                ('peer_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='fedele_bgp.bgppeergroup')),
                ...
                ('remote_as', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='remote_as', to='ipam.asn')),
