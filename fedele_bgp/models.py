...
class RoutingPolicy(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse('plugins:fedele_bgp:routingpolicy', args=[self.pk])
...
class BGPPeerGroup(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse('plugins:fedele_bgp:bgppeergroup', args=[self.pk])
...
class Community(BGPBase):
    ...
    def get_absolute_url(self):
        return reverse('plugins:fedele_bgp:community', args=[self.pk])
...
class BGPSession(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse('plugins:fedele_bgp:bgpsession', args=[self.pk])
...
class PrefixList(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse('plugins:fedele_bgp:prefixlist', args=[self.pk])
...
class PrefixListRule(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse('plugins:fedele_bgp:prefixlistrule', args=[self.pk])
...
class RoutingPolicyRule(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse('plugins:fedele_bgp:routingpolicyrule', args=[self.pk])
