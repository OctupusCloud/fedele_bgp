...
from fedele_bgp.models import (
    BGPSession, RoutingPolicy, BGPPeerGroup,
    Community, RoutingPolicyRule, PrefixList, PrefixListRule,
)

from fedele_bgp.choices import CommunityStatusChoices, SessionStatusChoices
...
class NestedRoutingPolicySerializer(WritableNestedSerializer):
    url = HyperlinkedIdentityField(view_name='plugins:fedele_bgp:routingpolicy')
...
class NestedBGPPeerGroupSerializer(WritableNestedSerializer):
    url = HyperlinkedIdentityField(view_name='plugins:fedele_bgp:bgppeergroup')
...
class NestedBGPSessionSerializer(WritableNestedSerializer):
    url = HyperlinkedIdentityField(view_name='plugins:fedele_bgp:bgpsession')
...
class NestedCommunitySerializer(WritableNestedSerializer):
    url = HyperlinkedIdentityField(view_name='plugins:fedele_bgp:community')
...
class NestedPrefixListSerializer(WritableNestedSerializer):
    url = HyperlinkedIdentityField(view_name='plugins:fedele_bgp:prefixlist')
